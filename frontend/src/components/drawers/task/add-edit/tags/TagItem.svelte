...
{#if optionsOpen === tag.id}
  <div
    ...
    class="absolute -inset-20 -bottom-40 -left-40"
  >
    <div class="flex w-36 flex-col gap-2 rounded-md border border-tgray-600 bg-white shadow-lg">
      <input
        type="text"
        class="z-50 mx-2 mt-2 rounded-md border border-tgray-600 bg-transparent px-2 py-0.5 text-sm"
        value={updateTitle}
      ...
      <div class="grid grid-cols-4 grid-rows-2 place-items-center gap-2 px-2 pb-2">
...
<button
  type="button"
  class="relative z-50 flex w-fit flex-row items-center gap-0 rounded-md px-2 py-0.5"
